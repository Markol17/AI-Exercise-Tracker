    ...
    def exercise(self):
        ...
        while True:
            ...
            try:
                ...
                if (
                    ...
                    cv2.putText(
                        ...
                        str(round(eang1, 2)),
                        (
                            idx_to_coordinates[23][0] - 40,
                            idx_to_coordinates[23][1] - 50,
                        ),
            ...
            try:
                ...
                cv2.rectangle(
                    image, (200, int(bar)), (260, 850), (0, 255, 0), cv2.FILLED
                )
                cv2.putText(
                    image,
                    f"{int(per)} %",
            ...
            if 0 in idx_to_coordinates:
                cv2.putText(
                    image,
                    "Plank Timer : " + str(round(plankDuration)) + " sec",
