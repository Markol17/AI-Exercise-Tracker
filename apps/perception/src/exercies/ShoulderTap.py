    ...
    def exercise(self):
        ...
        while True:
            ...
            try:
                ...
                if (
                    11 in idx_to_coordinates
                    and 13 in idx_to_coordinates
                    and 15 in idx_to_coordinates
                ):  # left side of body
                    cv2.line(
                        image,
                    ...
                    cv2.putText(
                        ...
                        str(round(ang1, 2)),
                        (
                            idx_to_coordinates[13][0] - 40,
                            idx_to_coordinates[13][1] - 50,
                        ),
                    ...
                    cv2.circle(
                        image, (idx_to_coordinates[11]), 10, (0, 0, 255), cv2.FILLED
                    )
                    cv2.circle(image, (idx_to_coordinates[11]), 15, (0, 0, 255), 2)
                    cv2.circle(
                        image, (idx_to_coordinates[13]), 10, (0, 0, 255), cv2.FILLED
                    )
                    cv2.circle(image, (idx_to_coordinates[13]), 15, (0, 0, 255), 2)
                    cv2.circle(
                        image, (idx_to_coordinates[15]), 10, (0, 0, 255), cv2.FILLED
                    )
                ...
                if (
                    ...
                    cv2.putText(
                        ...
                        str(round(ang2, 2)),
                        (
                            idx_to_coordinates[14][0] - 40,
                            idx_to_coordinates[14][1] - 50,
                        ),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.8,
                        color=(0, 255, 0),
                    ...
                    cv2.circle(
                        image, (idx_to_coordinates[12]), 10, (0, 0, 255), cv2.FILLED
                    )
                    cv2.circle(image, (idx_to_coordinates[12]), 15, (0, 0, 255), 2)
                    cv2.circle(
                        image, (idx_to_coordinates[14]), 10, (0, 0, 255), cv2.FILLED
                    )
                    cv2.circle(image, (idx_to_coordinates[14]), 15, (0, 0, 255), 2)
                    cv2.circle(
                        image, (idx_to_coordinates[16]), 10, (0, 0, 255), cv2.FILLED
                    )
            ...
            try:
                ...
                if frames > 80:
                    ...
                    if ang1 > 150 and performedLeftTap:
                        ...
                        # Send real-time tap count to mobile app
                        if count != last_sent_count:
                            ws_client.send_shoulder_tap_count(count)
                            last_sent_count = count
                            print(f"📱 Sent shoulder tap count: {count}")
