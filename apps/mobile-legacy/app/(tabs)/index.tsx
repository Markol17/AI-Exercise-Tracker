import { Session } from '@vero/api/types/core';
import { router } from 'expo-router';
import React from 'react';
import { Alert, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import { useStore } from '../../../mobile/stores/useStore';
import { useCreateSession, useEndSession } from '../../src/hooks/api';

export default function HomeScreen() {
	const { currentSession, setCurrentSession, currentMember, wsConnected } = useStore();
